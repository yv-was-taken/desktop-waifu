...
- add optionality to change between left and right side for chat (currently left, should be able to change to right.. perhaps automatically if possible? based on screen quadrants)
